...
//Line 2-4 checks if there is an active user, else redirect unknown user to home page
...
while (have_posts()) {
    ...
    <!--Lines 17-28 Checks if Quiz has already been completed, if quiz has not been completed adds Video modal else doesn't display video modal-->
    <?php if (!$completedThisQuiz) { ?>
        ...
        <?php wp_enqueue_script("video-JS", get_template_directory_uri() . '/js/videoModal.js'); ?>
    <?php } ?>
