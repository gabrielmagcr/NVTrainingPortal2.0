                ...
                <div class="mainVideo productLineVideo">
                    <div class="mainVideoImg productLineImg">
                        <?php if ($product_place_holder_image): ?>
                            <img class="placeholder-img placeholder-imgPL" src="/wp-content/uploads/lazyload.gif" data-src="<?php echo esc_url($product_place_holder_image); ?>" data-placeholder="/wp-content/uploads/lazyload.gif" alt="Placeholder Image">
                        <?php endif; ?>
                        <img class="play-icon playIconProductVideo" src="/wp-content/uploads/lazyload-transparent.gif" data-src="/wp-content/uploads/Button-play.svg" data-placeholder="/wp-content/uploads/lazyload-transparent.gif" alt="Play Button">
