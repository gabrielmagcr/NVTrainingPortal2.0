            ...
            while( have_rows('product_line') ) : the_row();
                ...
                <div class="mainVideo productLineVideo">
                    <div class="mainVideoImg productLineImg">
                        ...
                        <?php endif; ?>
                        <img class="play-icon playIconProductVideo lazy-load"  data-src="/wp-content/uploads/Button-play.svg" data-placeholder="/wp-content/uploads/lazyload.gif" alt="Play Button">
