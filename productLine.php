...
if( have_rows('product_line') ):
    ...
    $productVideo1 = get_field('productVideo');
    $pPlaceHolderImg = get_field('pPlaceHolderImg');
    $pVideoTitle = get_field('pVideoTitle');
    $pVideoText = get_field('pVideoText');
?>

        <div class="mainVideo productLineVideo">
            <div class="mainVideoImg productLineImg">
                <img class="placeholder-img placeholder-imgPL lazy-load " data-src="<?php echo $pPlaceHolderImg1 ?>"
            ...
            <div class="mainVideoText productLineText lazy-load">
                <h3>
                    <?php echo $pVideoTitle1 ?>
                </h3>
                <p>
                    <?php echo  $pVideoText1 ?>
                </p>
            </div>
        </div>
        <?php 
